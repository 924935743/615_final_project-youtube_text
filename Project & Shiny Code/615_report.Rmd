...
Please NOTE in this part, I used "udpipe" package to extract key words and phrases of description based on the logic of natural language. The drawback is the pace is SLOW when reviewers want to run the code.I am sorry to take up too much of your time.
